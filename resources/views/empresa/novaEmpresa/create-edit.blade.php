...
<div class="container">
    ...
    @endif
        ...
        {!! Form::text('cnpj', null, ['oninput'=> 'mascaracnpj(this)','placeholder'=>'CNPJ:', 'class'=>'form-control']) !!}
        </div>
        ...
        {!! Form::text('razao_social', null, ['placeholder'=>'Razão Social:', 'class'=>'form-control'])!!}
        </div> 
        ...
        {!! Form::text('telefone1', null, ['oninput'=> 'mascarafixo(this)','placeholder'=>'Telefone:', 'class'=>'form-control'])!!}
        ...
        {!! Form::text('celular', null, ['oninput'=> 'mascaracelular(this)','placeholder'=>'Celular:', 'class'=>'form-control'])!!}
        </div>
